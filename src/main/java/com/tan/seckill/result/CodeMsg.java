package com.tan.seckill.result;

/**
 * @ClassName CodeMsg
 * @Description TODO
 * @Author tan
 * @Date 2020/4/15 13:37
 * @Version 1.0
 **/
public class CodeMsg {
    ...
    //登录模块 5002XX
    public static CodeMsg SESSION_ERROR = new CodeMsg(500210, "用户未登录");
     ...
     * @return
     */
    public CodeMsg fillArgs(Object... args) {//"…"表示可变长参数(多个参数)
        int code = this.code;
